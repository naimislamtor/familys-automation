...
function createAIPostBannerSVG({ line1, line2, line3, subText, badgeText }) {
  ...
  <!-- Glassmorphic Central Graphic Card Frame -->
...
/**
 * Generate Content & Matching Real AI Frame Image Banner for ANY Custom Topic Prompt
 */
...
Example JSON output:
{
  ...
  "cardSubText": "কখনো আশা হারাবেন না"
    ...
    // Render 1080x1080 AI Graphic Frame Banner SVG Card with Embedded Base64 Font & "FAMILY'S POST" Footer
    ...
    console.log(`[AI Graphic Card Generator] Successfully generated Embedded Base64 Bengali Font Frame Card Banner!`);
